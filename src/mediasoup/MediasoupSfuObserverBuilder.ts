...
interface Builder {
    onMediasoup(mediasoup: any): this;
    toEndpoint(url: string): this,
...
export function mediasoupSfuObserverBuilder(): Builder {
    ...
    const _getSctpStreamBuilder = (transportId: any, streamId: any, stats: any): any => {
        ...
        builder = SfuSctpStreamBuilder.builder()
            .withTransportId(transportId)
    ...
    const comlinkBuilder = Comlink.builder();
    const result = {
        onMediasoup(mediasoup: any) {
            if (!mediasoup) {
        ...
        toEndpoint(endpoint: string) {
            comlinkBuilder.withEndpoint(endpoint);
            return result;
        },
        ...
        build() {
            ...
            const comlink = comlinkBuilder.build();
            const result = SfuObserver.builder()
