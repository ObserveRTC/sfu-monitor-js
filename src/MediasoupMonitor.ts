...
import { createLogger, setLevel as setLoggersLevel } from "./utils/logger";
import { Collector } from "./Collector";
import { SfuMonitor } from ".";
import { Collectors } from "./Collectors";
import { MediasoupConsumer, MediasoupDataConsumer, MediasoupDataProducer, MediasoupProducer, MediasoupRouter, MediasoupSurrogate, MediasoupTransport, MediasoupTransportType, MediasoupWorker } from "./mediasoup/MediasoupTypes";
import { MediasoupTransportCollector, MediasoupTransportCollectorConfig } from "./mediasoup/MediasoupTransportCollector";
import { MediasoupRouterCollector, MediasoupRouterCollectorConfig } from "./mediasoup/MediasoupRouterCollector";
import { MediasoupWorkerCollectorConfig, MediasoupWorkerCollector as MediasoupWorkerCollector } from "./mediasoup/MediasoupWorkerCollector";
...
import { MediasoupDataProducerCollector, MediasoupDataProducerCollectorConfig } from "./mediasoup/MediasoupDataProducerCollector";
import { MediasoupDataConsumerCollector, MediasoupDataConsumerCollectorConfig } from "./mediasoup/MediasoupDataConsumerCollector";
import { createSfuMonitor, SfuMonitorConfig } from "./SfuMonitor";
import { MediasoupSurrogateCollectorConfig, MediasoupSurrogateCollector } from "./mediasoup/MediasoupSurrogateCollector";
...
export class MediasoupMonitor implements SfuMonitor {
    ...
    public watchAll(mediasoup: MediasoupSurrogate, config?: MediasoupSurrogateCollectorConfig): MediasoupSurrogateCollector {
        const result = new MediasoupSurrogateCollector(
    ...
    public watchWorker(worker: MediasoupWorker, config?: MediasoupWorkerCollectorConfig): MediasoupWorkerCollector {
        const result = new MediasoupWorkerCollector(
            this._monitor.collectors,
            worker,
            config,
        );
    ...
    public watchRouter(router: MediasoupRouter, config?: MediasoupRouterCollectorConfig): MediasoupRouterCollector {
        const result = new MediasoupRouterCollector(
            this._monitor.collectors,
            router,
            config,
        );
    ...
    public watchConsumer(consumer: MediasoupConsumer, transportId: string, internal: boolean, config?: MediasoupConsumerCollectorConfig) {
    ...
    public watchProducer(producer: MediasoupProducer, transportId: string, internal: boolean, config?: MediasoupProducerCollectorConfig) {
    ...
    public watchDataConsumer(consumer: MediasoupDataConsumer, transportId: string, internal: boolean, config?: MediasoupDataConsumerCollectorConfig) {
    ...
    public watchDataProducer(producer: MediasoupDataProducer, transportId: string, internal: boolean, config?: MediasoupDataProducerCollectorConfig) {
    ...
    private _watchTransprot(transport: MediasoupTransport, transportType: MediasoupTransportType, config?: MediasoupTransportCollectorConfig): MediasoupTransportCollector {
        const result = new MediasoupTransportCollector(
            this._monitor.collectors,
            transport, {
                ...(config ?? {}),
                transportType,
